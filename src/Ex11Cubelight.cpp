...
void Ex11Cubelight::Update(float InDeltaTime)
{
   ...
   // Model = glm::rotate(Model, glm::radians(Angle), glm::vec3(0, 1, 0));
    ...
    glm::vec3 cubelightPos = PointLightPos + StormTrupperPos + glm::vec3(0,4,0);
    glm::mat4 CubeModel = glm::mat4(1.f);
    CubeModel = glm::translate(CubeModel, cubelightPos); //vec3(1, 0, 0) + vec3(3, -4, 0) + pivot cancelling
    ...
    glm::mat4 currentCubeMat = RotationAround * CubeModel;
    glm::vec3 currentCubePos = glm::vec3(currentCubeMat[3]);
    printf("vec %f %f %f \n",currentCubePos[0],currentCubePos[1],currentCubePos[2]);
    //currentCubePos = glm::vec3(0,sin(ElapsedTime)*5.f,0);
    Program->Bind();

    Program->SetUniform("point_light_pos",currentCubePos);

}

void Ex11Cubelight::Destroy()
{
