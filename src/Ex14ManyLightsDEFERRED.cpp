...
void Ex14ManyLightsDEFERRED::Start()
{
    ...
    /* SETUP Blending */
    QuadProgram = new OGLProgram("resources/shaders/deferred_quad.vert", "resources/shaders/many_lights_DEFERRED.frag");
    ...
    QuadProgram->SetUniform("light_num",light_number);
...
*/
void Ex14ManyLightsDEFERRED::Update(float InDeltaTime)
{
...
void Ex14ManyLightsDEFERRED::Destroy()
{
